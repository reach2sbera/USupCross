...
def save_dataset(args):
    ...
    patients_list =['L143', 'L192', 'L286',  'L310', 'L109', 'L067', 'L291', 'L506', 'L096', 'L333', 'L506']
...
def normalize_(image, MIN_B=-1024.0, MAX_B=1024.0):
    image[image <= MIN_B] = MIN_B
    image[image >= MAX_B] = MAX_B
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_path', type=str, default='/home1/sutanu/CT_d/ndct/')
